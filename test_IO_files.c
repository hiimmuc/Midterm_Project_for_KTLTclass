...
//int main() {
//
//    int numOfCus = count("customer_data.txt");//count customers
//    int numOfDrv = count("driver_data.txt");//count drivers
//
...
//    }
//    print_mat(cusCipMat, numOfCus, 2);
//    print_mat(CusCfpMat, numOfCus, 2);
//    print_mat(DrvDpMat, numOfDrv, 2);
//    return 0;
//}